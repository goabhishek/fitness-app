  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="SplashSchreen">
        ...
        <Stack.Screen name="SplashSchreen" component={SplashSchreen} options={{ headerShown: false }} />
        <Stack.Screen name="InfoHome1" component={InfoHome1} options={{ headerShown: false }} />
